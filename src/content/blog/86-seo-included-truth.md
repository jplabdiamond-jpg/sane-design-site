...
tags:
  ...
  - 見極め
faq:
  - q: "「SEO対策込み」のホームページ制作は本当にSEOされていますか？"
    a: "「SEO対策込み」の多くは、タイトルタグや見出し設定など内部対策の一部だけを指すことが多く、キーワード設計・コンテンツ追加・継続的な改善まで含むとは限りません。契約前に「具体的に何をするのか」を必ず確認することが重要です。"
  - q: "SEO対策されているか確認するポイントは？"
    a: "タイトルとメタディスクリプションが各ページ個別に設定されているか、見出し(hタグ)が適切か、表示速度とスマホ対応が良好か、サーチコンソールに登録されているか、狙うキーワードが明確か、を確認します。「上位保証」を謳う業者は要注意です。"
---
