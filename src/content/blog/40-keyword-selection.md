...
faq:
  - q: "SEOのキーワード選定とは何ですか？"
    a: "キーワード選定とは、お客さんが検索エンジンで実際に使う言葉を調べ、自分のサイトで狙うべき言葉を決める作業です。SEOの土台であり、業界用語ではなく「お客さんが使う言葉」で記事を書くことが上位表示の第一歩になります。"
  - q: "キーワード調査に使える無料ツールは？"
    a: "Googleのサジェスト（検索候補）、ラッコキーワード、Googleキーワードプランナー、Googleサーチコンソールが無料で使えます。まずは実際にGoogleやSNSで検索して、お客さんがどんな言葉を使うかを観察するのが有効です。"
---
