...
faq:
  - q: "内部SEOと外部SEOの違いは何ですか？"
    a: "内部SEOは自サイト内で行う対策（タイトル設定・内部リンク・表示速度・コンテンツの質など、自分でコントロールできるもの）、外部SEOはサイトの外からの評価を高める対策（他サイトからの被リンクや指名検索・SNSでの言及など）です。まず内部SEOから着手するのが基本です。"
  - q: "初心者がまず取り組むべきSEO対策は？"
    a: "初心者はまず内部SEOから始めましょう。具体的には、各ページのタイトルと見出しを整える、検索意図に合った記事を書く、表示速度とスマホ対応を改善する、内部リンクで関連ページをつなぐことです。外部SEO（被リンク獲得）は良質なコンテンツを積み重ねた先に自然についてきます。"
---
