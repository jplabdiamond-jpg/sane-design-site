...
<p class="detail-lead">ファイナンシャルプランナーのサービス紹介画像（ココナラ出品用）。住宅ローン・保険の見直しメリットを、図解で分かりやすく伝えるデザインにしました。</p>

<div class="detail-body">

## コンセプト

お金の相談は「何が得になるのか」を具体的に示すことが信頼につながります。メリットを6つの図解で整理し、専門知識がなくても理解できる構成にすることをコンセプトにしました。

## デザインで意識した点

親しみやすいイラストと柔らかい配色で、お金の話題への心理的ハードルを下げる誌面を構築。各メリットをカード状に整理し、視線の流れに沿って読み進められるようにしています。

## ターゲットと訴求

家計や保険の見直しを考える個人が対象。具体的な相談メリットを示し、出品サービスとして問い合わせ・購入につながるよう訴求しました。
