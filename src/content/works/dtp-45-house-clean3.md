...
<p class="detail-lead">ハウスクリーニング業者「ECO Cheap」の営業チラシ。「過去のお掃除、ハウスクリーニングのプロがまるっと解決」を軸に訴求しました。</p>

<div class="detail-body">

## コンセプト

「自分では落とせない汚れもプロなら解決できる」という安心感を伝えることがコンセプト。困りごとへの共感から、プロに頼む価値へと導く構成にしました。

## デザインで意識した点

緑を基調にエコで清潔なイメージを演出し、対応内容と料金を整理。スタッフ写真で信頼感を補強し、初めてでも依頼しやすい誌面に仕上げています。

## ターゲットと訴求

掃除に悩む家庭が対象。サービス内容と連絡先を明確にし、相談・依頼への導線を整えました。
