...
レクサスRX専門の買取査定LPです。テーマは「上質な体験の延長線上にある、納得の売却」。レクサスというブランドが持つ静謐な高級感を損なわないよう、装飾を足し算するのではなく、余白・写真・タイポグラフィの引き算で世界観を表現しました。ファーストビューで車両ビジュアルとキャッチコピーを大きく見せ、「このお店なら安心して任せられそう」という第一印象を数秒で伝えることを最優先に設計しています。

## デザインで意識した点

配色はディープブラックとシャンパンゴールドを基調に、信頼感と上質さを両立。フォントは可読性の高いゴシックに絞り、価格や強みなど「伝えるべき数字」だけが視線に飛び込むよう情報の優先順位を明確にしました。査定フォームへ向かう導線は常に1タップで届く位置に固定配置し、離脱を防いでいます。
...
<figure class="lexus-shot">
  <img src="/works/work-32-full.webp" alt="レクサスRX買取専門店様LP 全体キャプチャ" loading="lazy" />
