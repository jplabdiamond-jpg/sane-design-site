...
<p class="detail-lead">書店のイベント告知チラシ。「このチラシ持参で1万円分が当たるチャンス」というインセンティブで来店動機を作るデザインにしました。</p>

<div class="detail-body">

## コンセプト

実店舗への集客には「来店する理由」が必要です。プレゼント企画を主役に据え、参加方法を分かりやすく示すことで、来店行動を促すことをコンセプトにしました。

## デザインで意識した点

明るくポップな配色と賞品ビジュアルで、わくわく感を演出。A賞〜D賞の内容と応募方法を整理し、誰でも参加したくなる誌面に仕上げています。

## ターゲットと訴求

地域の来店客が対象。チラシ持参という来店トリガーを設け、期間とルールを明確にすることで、確実な集客につなげる設計にしました。
