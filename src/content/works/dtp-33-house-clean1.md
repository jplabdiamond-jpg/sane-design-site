...
<p class="detail-lead">ハウスクリーニング業者の新規顧客獲得チラシ。「エアコンや洗濯機を丸ごとクリーニング」を軸に、プロの仕上がりを訴求しました。</p>

<div class="detail-body">

## コンセプト

ハウスクリーニングは「どこまでキレイになるか」「いくらか」が来店動機です。対応箇所と料金を明快に示し、プロに頼む価値を伝えることをコンセプトにしました。

## デザインで意識した点

黄色と青の元気な配色で目を引き、対応メニューをアイコンで整理。作業員のイラストで親しみやすさを出し、初めてでも依頼しやすい誌面に仕上げています。

## ターゲットと訴求

家庭の主婦・共働き世帯が対象。出張費無料などの強みを訴求し、電話・QRの依頼導線を明確にして新規顧客獲得につなげました。
