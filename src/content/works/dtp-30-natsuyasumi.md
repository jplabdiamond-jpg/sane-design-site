...
<p class="detail-lead">夏休みの催事イベントチラシ。スパレジャーや特別企画を盛り込み、家族の来場を促す賑やかな夏らしいデザインにしました。</p>

<div class="detail-body">

## コンセプト

季節催事は「行きたくなる楽しさ」を伝えることが集客の鍵です。夏休みらしいわくわく感を誌面全体で演出し、家族で訪れたくなる期待感を作ることをコンセプトにしました。

## デザインで意識した点

青と暖色を組み合わせた爽やかで賑やかな配色に、イベント内容を写真とアイコンで整理。情報量が多くても楽しく読める、活気あるレイアウトに仕上げています。

## ターゲットと訴求

ファミリー層が対象。開催日時・内容・特典を分かりやすく示し、夏休みの来場計画に組み込んでもらうことを狙いました。
