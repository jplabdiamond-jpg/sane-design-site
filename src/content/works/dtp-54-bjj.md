...
<p class="detail-lead">ブラジリアン柔術ジム「BLAST BJJ STUDIO」のフライヤー。「楽しくエクササイズ」を軸に、初心者でも始めやすい雰囲気を訴求しました。</p>

<div class="detail-body">

## コンセプト

格闘技ジムは「怖そう・きつそう」という先入観を払拭することが入会の鍵です。初心者大歓迎・楽しさを前面に出し、誰でも気軽に始められることをコンセプトにしました。

## デザインで意識した点

黒を基調にしたスタイリッシュな配色に、躍動感のある写真とロゴを大胆配置。本格感を保ちつつ、明るいコピーで親しみやすさを加えた誌面に仕上げています。

## ターゲットと訴求

運動不足解消・新しい趣味を探す層が対象。「初心者大歓迎」「24時間365日」など強みを訴求し、体験・問い合わせへの導線を明確にしました。

</div>

<figure class="detail-shot">
  <img src="/works/dtp-54-full.webp" alt="ブラジリアン柔術ジムフライヤー 全体" loading="lazy" />
