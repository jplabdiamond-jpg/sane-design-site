...
<p class="detail-lead">ネイルサロンの店舗オープンチラシ。「NEW OPEN」とリピート率の高さを訴求し、女性が通いたくなる華やかなデザインにしました。</p>

<div class="detail-body">

## コンセプト

ネイルサロンは「センスの良さ」と「通いやすさ」が来店動機です。デザイン性の高さとリピート実績を見せ、信頼と憧れの両方を喚起することをコンセプトにしました。

## デザインで意識した点

やわらかなピンクと上品なあしらいで、女性らしく華やかな世界観を構築。オープン特典とメニューを整理し、初回来店のきっかけを作る誌面に仕上げています。

## ターゲットと訴求

ネイルを楽しみたい女性が対象。オープン記念特典と予約導線（QR・電話）を明確にし、来店につなげる設計にしました。

</div>

<figure class="detail-shot">
  <img src="/works/dtp-38-full.webp" alt="ネイルサロン様の店舗オープンチラシデザイン 全体" loading="lazy" />
