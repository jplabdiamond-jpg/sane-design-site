...
<p class="detail-lead">不用品買取店のチラシ。「家にある不用品の資産価値、べてみませんか？」という問いかけで、気軽な査定依頼を促すデザインにしました。</p>

<div class="detail-body">

## コンセプト

買取サービスは「高く売れそう」「気軽に頼めそう」と感じさせることが重要です。「他社より幅広く買取」という強みを前面に出し、相談のきっかけを作ることをコンセプトにしました。

## デザインで意識した点

明るく親しみやすい配色とスタッフの写真で、安心して相談できる印象を構築。買取対象や流れを整理し、初めてでも依頼しやすい誌面に仕上げています。

## ターゲットと訴求

不用品の処分・売却を考える個人が対象。買取UPクーポンや査定無料を訴求し、来店・問い合わせへの導線を明確にしました。
