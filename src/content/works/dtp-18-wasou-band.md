...
<p class="detail-lead">和装侍系音楽バンドのLIVE告知チラシ。和とロックが融合した独特の世界観を、力強くスタイリッシュなデザインで表現しました。</p>

<div class="detail-body">

## コンセプト

バンドの個性＝「和×ロック」の世界観をビジュアルで体現することがコンセプト。ライブの熱量とアーティストのカリスマ性を、誌面全体で強く印象づけることを狙いました。

## デザインで意識した点

黒を基調に和柄や赤のアクセントを効かせ、侍らしい凛々しさと音楽の躍動感を両立。ライブ写真とロゴを大胆に配置し、ファンの心を掴むインパクトある誌面に仕上げています。

## ターゲットと訴求

バンドのファン・ライブ来場者が対象。日時・会場・チケット情報を明確に整理し、SNSやQRからの情報拡散とチケット購入につなげる設計にしました。
