...
<p class="detail-lead">ライブ配信者（ライバー）募集チラシ。「新規ライバー募集中！登録料・月額0円」を軸に、気軽に始められる魅力を訴求しました。</p>

<div class="detail-body">

## コンセプト

新しい働き方として注目されるライバーを、「リスクなく始められる」という切り口で訴求することがコンセプト。無料で挑戦できる点を強調し、応募のハードルを下げました。

## デザインで意識した点

ステージ風の華やかなビジュアルとビビッドな配色で、エンタメらしい高揚感を演出。対応アプリやサポート内容を整理し、未経験でも安心して始められる誌面に仕上げています。

## ターゲットと訴求

配信に興味のある若年層が対象。「登録料・月額0円」のメリットを大きく打ち出し、QR・公式LINEからの応募導線を明確にしました。

</div>

<figure class="detail-shot">
  <img src="/works/dtp-26-full.webp" alt="ライバー募集チラシデザイン 全体" loading="lazy" />
