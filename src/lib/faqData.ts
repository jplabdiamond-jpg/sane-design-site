...
const FAQS: Record<Locale, QA[]> = {
  ja: [
    ...
    { q: 'SEO対策もお願いできますか？', a: 'はい。内部SEO対策と、指定キーワードに基づくブログ記事の追加に対応しています。料金は15,000円〜です。なお検索順位の変動には通常数週間〜数ヶ月かかります。' },
  ...
  en: [
    ...
    { q: 'Can you handle SEO too?', a: 'Yes. We handle internal SEO and adding blog articles based on your target keywords, from ¥15,000. Note that search ranking changes usually take several weeks to a few months.' },
